...
function showDedicationText() { //seguidores
  ...
  if (!text) {
    text = `En tus ojos haye mi calma, en tus brazos mi lugar eres el sol de mis mañanas y mi razon para soñar. :)`;  } else {
...
function showSignature() {
  ...
  signature.textContent = firma ? decodeURIComponent(firma) : "Con amor, Lucerito";
...
function showCountdown() {
  ...
  function update() {
    ...
    container.innerHTML =
      `Nuestra historia tiene: <b>${days}</b> días<br>` +
      `Nuestro día especial en: <b>${eventDays}d ${eventHours}h ${eventMinutes}m ${eventSeconds}s</b>`;
